...
export default function Header({ currentPage = 'home' }: HeaderProps) {
    ...
    if (!mounted) {
        return (
            <header className="bg-white/95 dark:bg-background/70 backdrop-blur-md shadow-sm border-b border-gray-200/50 dark:border-foreground/10 sticky top-0 z-50 transition-all duration-300 ease-in-out">
    ...
    return (
        <header className="bg-white/95 dark:bg-background/70 backdrop-blur-md shadow-sm border-b border-gray-200/50 dark:border-foreground/10 sticky top-0 z-50 transition-all duration-300 ease-in-out dark:hover:border-primary/20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    {/* Logo */}
                    <Link href="/" className="flex items-center gap-1 md:gap-0 hover:opacity-80 transition-all duration-200 ease-in-out hover:scale-105 ">
                        ...
                        <h1 className="text-xl sm:text-2xl font-bold text-foreground leading-none md:pb-1">Dineezy</h1>
                    </Link>
                        ...
                        {navItems.map((item, index) => (
                            ...
                            >
                                ...
                                {currentPage === item.key && (
                                    <div className="absolute -bottom-1 left-0 right-0 h-0.5 bg-foreground rounded-full animate-in slide-in-from-left duration-300"></div>
                                )}
                            </Link>
                        ))}
                    </nav>
                    ...
                    <div className="flex items-center gap-2 sm:gap-3 ml-auto">
                        ...
                        <button className="hidden sm:block p-2 rounded-full bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 transition-all duration-200 hover:scale-110">
                            <svg fill="currentColor" height="16" width="16" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg" className="text-muted-foreground">
                        ...
                        {user ? (
                            ...
                            <div className="flex items-center gap-1 sm:gap-2">
                                <Link
                                    ...
                                    className="px-2 sm:px-3 py-1 text-xs sm:text-sm font-medium text-muted-foreground hover:text-foreground transition-colors"
                                >
                                    Login
                                </Link>
                                {/* <Link
                        ...
                        <button
                            ...
                            className={`md:hidden ml-1 sm:ml-2 flex h-8 sm:h-10 w-8 sm:w-10 items-center justify-center rounded-xl text-muted-foreground hover:bg-gray-100 dark:hover:bg-gray-700 transition-all duration-200 hover:scale-105 ${isMobileMenuOpen ? 'bg-gray-100 dark:bg-gray-700' : ''
                                }`}
