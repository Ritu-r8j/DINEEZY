                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        {order.restaurant?.name || 'Restaurant'} • {new Date(order.createdAt).toLocaleDateString()} at {new Date(order.createdAt).toLocaleTimeString([], {hour: '2-digit', minute:'2-digit'})}
                      </p>
          ...
          <div className="mt-12 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              >
                ...
                <h4 className="font-medium text-gray-900 dark:text-white">Your Favorites</h4>
                <p className="text-sm text-gray-600 dark:text-gray-400">Reorder favorites</p>
              </button>
