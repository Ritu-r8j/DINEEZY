...
export default function Checkout() {
    ...
    const updateQuantity = (id: string, change: number) => {
        ...
        if (newQuantity <= 0) {
            ...
            const result = CartManager.removeFromCart(id);
            if (result.success) {
            ...
            // Update quantity
            const result = CartManager.updateCartItemQuantity(id, newQuantity);
            if (result.success) {
                setCartItems(result.cartItems);
            }
        }
    ...
    return (
        <div className="min-h-screen bg-white dark:bg-gray-900">
            <div className="mx-auto w-full max-w-7xl px-4 mt-3 sm:px-6 lg:px-8 lg:pt-3 py-3 sm:py-4 md:py-6 pb-20 lg:pb-6">
                {/* Page Title */}
                <motion.div 
                ...
                <div className="grid grid-cols-1 xl:grid-cols-3 gap-3 sm:gap-4 md:gap-6">
                    ...
                    <div className="xl:col-span-2">
                        <motion.div 
                            className="flex flex-wrap items-center justify-between rounded-3xl bg-muted/10 shadow-sm backdrop-blur lg:flex-nowrap relative z-50 bg-white dark:bg-gray-800 rounded-lg sm:rounded-xl md:rounded-2xl border border-gray-200 dark:border-gray-600 p-3 sm:p-4 md:p-6"
                            initial={{ opacity: 0, y: -40 }}
                            animate={{ opacity: 1, y: 0 }}
                            transition={{ duration: 0.9 }}
                        >
                                        ...
                                        <div className="mb-4 sm:mb-6">
                                            ...
                                            {user ? (
                                                <div className="space-y-3">
                                                    <div className="bg-gray-100 dark:bg-gray-800/50 border border-gray-300 dark:border-gray-600 rounded-lg p-3 mb-3">
                                                        <div className="flex items-center gap-2 text-gray-800 dark:text-gray-300">
                                                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                                                            </svg>
                                                            <span className="text-xs sm:text-sm font-medium">Using your account info</span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                                                        <div>
                                                            ...
                                                            <input
                                                                ...
                                                                className="w-full px-3 py-2 sm:px-4 sm:py-3 text-sm sm:text-base border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-black dark:focus:ring-white focus:border-transparent transition-colors"
                                                            />
                                                        </div>
                                                        <div>
                                                            <label className="block text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                                                ...
                                                <div className="space-y-3">
                                                    <div className="bg-gray-100 dark:bg-gray-800/50 border border-gray-300 dark:border-gray-600 rounded-lg p-4 mb-4">
                                                        <div className="flex items-center gap-2 text-gray-800 dark:text-gray-300">
                                                ...
                                                {orderTypes.map((type) => (
                                                    <div
                                                        ...
                                                        className={`${styles.orderTypeCard} p-3 sm:p-4 md:p-5 rounded-lg sm:rounded-xl border-2 cursor-pointer transition-all ${type.selected
                                                            ? 'border-black dark:border-white bg-black/10 dark:bg-white/10 shadow-lg dark:shadow-white/20'
                                                        ...
                                                        >
                                                            ...
                                                            <div className="text-right">
                                                                ...
                                                                <div className={`w-4 h-4 sm:w-5 sm:h-5 rounded-full border-2 flex items-center justify-center mt-1 ${option.selected
                                                                    ...
                                                                    {option.selected && (
                                                                        <div className="w-2 h-2 sm:w-2.5 sm:h-2.5 rounded-full bg-black dark:bg-white"></div>
                                                                    )}
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="mb-6 sm:mb-8">
                                            ...
                                            <textarea
                                                ...
                                                className="w-full p-3 sm:p-4 text-sm sm:text-base border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-black dark:focus:ring-white focus:border-transparent resize-none"
                                                rows={3}
                                            />
                                                    ...
                                                    <div key={item.id} className="flex items-center gap-2 sm:gap-3 p-3 sm:p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700">
                                                        ...
                                                        <div className="flex items-center gap-2 sm:gap-3">
                                                            <div className="flex items-center gap-1 sm:gap-2">
                                                                ...
                                                                <span className="font-semibold w-6 sm:w-8 text-center text-xs sm:text-sm">{item.quantity || 1}</span>
                                                                <button
                                                                    onClick={() => updateQuantity(item.id, 1)}
                                                                    className="w-6 h-6 sm:w-8 sm:h-8 flex items-center justify-center rounded-full bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-gray-600 border border-gray-300 dark:border-gray-600 transition-colors cursor-pointer"
                                                                >
                                        ...
                                        <div className="mb-6 sm:mb-8">
                                            ...
                                            <div className="flex gap-2 sm:gap-3">
                                                <input
                                                    ...
                                                    className="flex-1 px-3 py-2 sm:px-4 sm:py-3 text-sm sm:text-base border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-black dark:focus:ring-white focus:border-transparent transition-colors"
                                                />
                                    ...
                                    <div className="flex justify-between pt-4 sm:pt-6 border-t border-gray-200 dark:border-gray-600">
                                        ...
                                        <button
                                            ...
                                            className={`px-4 sm:px-6 md:px-8 py-2 sm:py-3 rounded-lg text-xs sm:text-sm font-semibold transition-all cursor-pointer ${isPlacingOrder || !isFormValid()
                                                ? 'bg-gray-300 dark:bg-gray-600 text-gray-500 dark:text-gray-400'
                                                : 'bg-gradient-to-r from-black to-black hover:from-gray-800 hover:to-gray-800 dark:from-white dark:to-white dark:hover:from-gray-200 dark:hover:to-gray-200 text-white dark:text-black shadow-lg'
                                                }`}
                                        >
                                            {isPlacingOrder ? (
                                                <>
                    ...
                    <div className="hidden xl:block xl:col-span-1">
                        <motion.div 
                            className="flex flex-wrap items-center justify-between rounded-3xl bg-muted/10 shadow-sm backdrop-blur lg:flex-nowrap relative z-50 bg-white dark:bg-gray-800 rounded-lg sm:rounded-xl md:rounded-2xl border border-gray-200 dark:border-gray-600 p-4 sm:p-6 sticky top-20"
                            initial={{ opacity: 0, y: -40 }}
                            animate={{ opacity: 1, y: 0 }}
                            transition={{ duration: 0.9 }}
                        >
                            ...
                            {/* Order Info */}
                            <div className="bg-gray-100 dark:bg-gray-800/50 border border-gray-300 dark:border-gray-600 rounded-lg p-3 sm:p-4">
                                <div className="text-xs sm:text-sm text-gray-800 dark:text-gray-200">
                                    ...
                                    <p className="text-gray-700 dark:text-gray-300">{estimatedTime}</p>
                                </div>
                            </div>
            ...
            <div className="xl:hidden fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-800 border-t-2 border-gray-300 dark:border-gray-600 shadow-xl dark:shadow-gray-900/50 z-50 backdrop-blur-sm transition-all duration-300">
                ...
                >
                    <div className="flex items-center gap-2 sm:gap-3">
                        <div className="w-7 h-7 sm:w-8 sm:h-8 md:w-10 md:h-10 bg-black dark:bg-white rounded-full flex items-center justify-center shadow-lg ring-2 ring-black/20 dark:ring-white/20">
                            <span className="text-white dark:text-black text-xs sm:text-sm font-bold">{cartItems.length}</span>
                        </div>
                        <div>
                    ...
                    <div className="flex items-center gap-1 sm:gap-2">
                        <button
                            ...
                            className={`px-3 py-1.5 sm:px-4 sm:py-2 md:px-6 md:py-3 rounded-lg text-xs sm:text-sm font-bold transition-all duration-200 ease-out relative overflow-hidden ${isFormValid() && !isPlacingOrder
                                ? 'bg-black dark:bg-white hover:bg-gray-800 dark:hover:bg-gray-200 text-white dark:text-black shadow-lg ring-2 ring-black/20 dark:ring-white/20 hover:shadow-xl cursor-pointer'
                ...
                <div className={`transition-all duration-300 ease-out overflow-hidden transform origin-top ${isSummaryExpanded ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'
                    ...
                    <div className="px-3 sm:px-4 pb-3 sm:pb-4 border-t border-gray-300 dark:border-gray-600">
                        ...
                        {/* Order Info */}
                        <div className="bg-gray-100 dark:bg-gray-800/50 border border-gray-300 dark:border-gray-600 rounded-lg p-2 sm:p-3">
