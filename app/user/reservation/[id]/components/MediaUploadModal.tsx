            ...
            {!isUploadingMedia && (
              <div>
                ...
                <label
                  ...
                  className="flex flex-col items-center justify-center w-full h-64 border-2 border-dashed border-gray-300 dark:border-foreground/5 rounded-xl cursor-pointer hover:border-indigo-400 dark:hover:border-primary/20 transition-colors bg-gray-50 dark:bg-background/70"
                >
            ...
            {isUploadingMedia && uploadingMedia.length > 0 && (
              <div className="space-y-4">
                ...
                {uploadingMedia.map((file, index) => {
                  ...
                  return (
                    <div key={fileKey} className="bg-gray-50 dark:bg-background/70 rounded-lg p-4 border border-gray-200 dark:border-foreground/5 transition-all duration-300 hover:shadow-md dark:hover:border-primary/20">
                      <div className="flex items-center gap-3 mb-3">
                        <div className="w-12 h-12 bg-gray-200 dark:bg-background/70 rounded-lg flex items-center justify-center flex-shrink-0 border border-gray-200 dark:border-foreground/5">
                          {isImage ? (
